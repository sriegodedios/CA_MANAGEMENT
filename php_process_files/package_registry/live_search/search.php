...
// Output HTML formats
$html = '<tr>';
$html .= '<td class="small">LNameString</td>';
$html .= '<td class="small">FNameString</td>';
$html .= '<td class="small">WiDString</td>';
$html .= '<td class="small">RNString</td>';
$html .= '</tr>';
...
echo($o);
 ...
 $o = str_replace('LNameString', '<span class="label label-danger">No Names Found</span>', $html);
 $o = str_replace('FNameString', '', $o);
 $o = str_replace('WiDString', '', $o);
 $o = str_replace('RNString', '', $o);
 // Output
 echo($o);
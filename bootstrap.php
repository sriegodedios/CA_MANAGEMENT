...
$query = ("SELECT * FROM Package_List WHERE Date_Checked_IN = '$current_date'") or die(mysql_error());
  ...
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="#section2">Package Registry</a></li>
        ...
        <div class="col-sm-4">
		  ...
		  <form>
           <fieldset class="form-group">
				<label for="exampleInputEmail1">View Packages</label>
				<input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
				<small class="text-muted">Swipe Wildcat ID Card</small>
